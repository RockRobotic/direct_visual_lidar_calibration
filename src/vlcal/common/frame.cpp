...
bool Frame::has_times() const { return times; }

bool Frame::has_points() const { return points; }

bool Frame::has_normals() const { return normals; }

bool Frame::has_covs() const { return covs; }

bool Frame::has_intensities() const { return intensities; }
