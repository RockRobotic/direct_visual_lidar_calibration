...
Eigen::Isometry3d
PoseEstimation::estimate(const camera::GenericCameraBase::ConstPtr &proj,
...
Eigen::Matrix3d PoseEstimation::estimate_rotation_ransac(
    ...
    const std::vector<std::pair<Eigen::Vector2d, Eigen::Vector4d>> &correspondences, std::vector<bool> *inliers)
{
...
Eigen::Isometry3d
PoseEstimation::estimate_pose_lsq(const camera::GenericCameraBase::ConstPtr &proj,
                                  const std::vector<std::pair<Eigen::Vector2d, Eigen::Vector4d>> &correspondences,
                                  const Eigen::Isometry3d &init_T_camera_lidar)
{
    ...
    // problem.AddParameterBlock(T_camera_lidar.data(), Sophus::SE3d::num_parameters, new
    // Sophus::Manifold<Sophus::SE3>());
