...
camera::GenericCameraBase::ConstPtr create_camera(const std::vector<double> &intrinsics,
                                                  const std::vector<double> &distortion_coeffs)
{
    if (intrinsics.size() != camera::CameraModelTraits<Projection>::num_intrinsic_params)
    {
        std::cerr << vlcal::console::bold_red << "error: num of intrinsic parameters mismatch!!"
                                                  ...
                                                  const std::vector<double> &distortion_coeffs)
{
    ...
    std::cerr << vlcal::console::bold_red << "error: unknown camera model " << camera_model << vlcal::console::reset
              << std::endl;
    return nullptr;
}
