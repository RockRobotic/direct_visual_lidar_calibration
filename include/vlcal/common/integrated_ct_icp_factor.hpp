...
class IntegratedCT_ICPFactor_ : public gtsam::NonlinearFactor
{
  public:
     ...
     */
    IntegratedCT_ICPFactor_(gtsam::Key source_t0_key, gtsam::Key source_t1_key,
    ...
    const std::vector<gtsam::Pose3, Eigen::aligned_allocator<gtsam::Pose3>> &get_source_poses() const
    {
        return source_poses;
    }

    std::vector<Eigen::Vector4d, Eigen::aligned_allocator<Eigen::Vector4d>>
    deskewed_source_points(const gtsam::Values &values, bool local = false);
