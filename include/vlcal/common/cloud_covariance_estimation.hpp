...
class CloudCovarianceEstimation
{
  public:
     ...
     */
    void estimate(const std::vector<Eigen::Vector4d, Eigen::aligned_allocator<Eigen::Vector4d>> &points,
    ...
    estimate(const std::vector<Eigen::Vector4d, Eigen::aligned_allocator<Eigen::Vector4d>> &points,
     ...
     */
    Eigen::Matrix4d regularize(const Eigen::Matrix4d &cov, Eigen::Vector3d *eigenvalues = nullptr,
