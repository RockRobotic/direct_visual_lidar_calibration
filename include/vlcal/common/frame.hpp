...
struct Frame
{
  public:
    ...
    Frame() : num_points(0), times(nullptr), points(nullptr), normals(nullptr), covs(nullptr), intensities(nullptr) {}
    virtual ~Frame() {}
     ...
     */
    template <typename T> const T *aux_attribute(const std::string &attrib) const
    {
