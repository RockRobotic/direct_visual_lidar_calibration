...
template <int N> class DirectionalDirectSearch : public Optimizer<N>
{
  public:
    struct Params
    {
        Params()
            : init_alpha(0.5), min_alpha(1e-5), alpha_dec_factor(1.0 / 8.0), alpha_inc_factor(2.0), max_iterations(1024)
        {
        }
