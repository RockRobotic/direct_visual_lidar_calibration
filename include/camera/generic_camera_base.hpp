...
class GenericCameraBase
{
  public:
     ...
     * @note  Is there a better way to accept Jets with different number of params without exposing the implementation
     * of the projection func?
     */
    virtual Eigen::Matrix<ceres::Jet<double, 7>, 2, 1>
    operator()(const Eigen::Matrix<ceres::Jet<double, 7>, 3, 1> &point_3d) const = 0;
};
