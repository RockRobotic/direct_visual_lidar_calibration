...
struct PinholeProjection
{
    ...
    auto distort(const T *const distortion, const Eigen::Matrix<T2, 2, 1> &pt) const
...
// traits
template <> struct CameraModelTraits<PinholeProjection>
{
    ...
    static Eigen::Vector4d init_intrinsic(int width, int height, const Eigen::VectorXd &pinhole_intrinsic)
    {
