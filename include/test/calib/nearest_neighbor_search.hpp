...
template <class T, class DataSource, typename _DistanceType> class L2_Simple_Adaptor;

template <typename Distance, class DatasetAdaptor, int DIM, typename IndexType> class KDTreeSingleIndexAdaptor;
...
class KdTreeNearestNeighborSearch : public NearestNeighborSearch
{
  public:
    using Index =
        nanoflann::KDTreeSingleIndexAdaptor<nanoflann::L2_Simple_Adaptor<double, KdTreeNearestNeighborSearch, double>,
                                            KdTreeNearestNeighborSearch, 2, size_t>;
